  ...
  return (
    <Popover>
      <PopoverTrigger className="relative flex size-10 items-center justify-center rounded-lg">
        ...
        />
        {count > 0 && (
          <div className="absolute right-2 top-2 z-20 size-2 rounded-full bg-red-600" />
        )}
      </PopoverTrigger>
        ...
        >
          <InboxNotificationList>
            {unreadNotifications.length <= 0 && (
              <p className="py-2 text-center text-[#AC9C8D]">No new notifications</p>
            )}
            ...
            {unreadNotifications.length > 0 && unreadNotifications.map((notification) => (
              <InboxNotification 
                ...
                className="customGradient text-[#AC9C8D]"
